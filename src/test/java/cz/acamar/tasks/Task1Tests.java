...
public class Task1Tests {
    ...
    //TODO: adding one more plus test case metod
    @ParameterizedTest
    @MethodSource("stringsAndLastWordLengthPlus")
    void test_lastWordLengthPlus(String str, int lastWordLength) {
        assertEquals(lastWordLength, task1.lengthOfLastWord(str));
    }

    private static Stream<Arguments> stringsAndLastWordLengthPlus() {
        return Stream.of(
                Arguments.of("Hello world hello", 5),
                Arguments.of("   fly me   to   the moon happy  ", 5),
                Arguments.of("William Shakespeare was an English", 7)
        );
    }
}
